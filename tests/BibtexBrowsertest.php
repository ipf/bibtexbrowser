...
//    $this->assertTrue(strpos('A Book{} $\mbox{foo}$',$first_entry->toHTML());
    ...
    public function test_PagedDisplay()
    {
        $PAGE_SIZE = 4;
    ...
    public function test_emptyGetPdfLink()
    {
        bibtexbrowser_configure('BIBTEXBROWSER_LINKS_TARGET', '_self');
        $bibtex = "
        @article{aKey,
    ...
    public function test_parsing_author_list()
    {
    ...
    public function testscholarlink()
    {
        bibtexbrowser_configure('BIBTEXBROWSER_LINKS_TARGET', '_self');
        bibtexbrowser_configure('BIBTEXBROWSER_BIBTEX_VIEW', 'original');
...
//         print($output);
    ...
    public function test_bug_201808()
    {
        $btb = new BibDataBase();
        $btb->load('bibacid-utf8.bib');
    ...
    public function test_multiple_table()
    {
        ob_start();
